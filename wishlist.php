...
<section class="wishlist">
   ...
   <?php
      ...
      if($select_wishlist->rowCount() > 0){
         while($fetch_wishlist = $select_wishlist->fetch(PDO::FETCH_ASSOC)){ 
            ...
            $fetch_product_quantity->execute([$fetch_wishlist['pid']]);
            $product_quantity = $fetch_product_quantity->fetch(PDO::FETCH_ASSOC);
   ?>
   <form action="" method="POST" class="box">
      ...
      <div class="stock">Stock: <?= $product_quantity['quantity']; ?></div>
      <input type="number" min="1" max="<?= $product_quantity['quantity']; ?>" value="1" class="qty" name="p_qty">
